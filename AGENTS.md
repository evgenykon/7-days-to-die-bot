...
- **ПРОВАЛ: потратил 30+ попыток и 2 часа на то что должно работать с первого раза.** Каждая версия мода что-то ломала — NRE, краш, спам в консоль. Надо было начинать с минимального работающего прототипа и НЕ менять entity class посредине.
